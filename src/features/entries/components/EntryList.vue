...
const showEntries = computed(
  () => entryFetch.value.entries && entryFetch.value.entries.length > 0 && !entryFetch.value.error
)
</script>
        ...
        <TableCell class="font-medium">
          <div class="flex flex-col gap-1">
            ...
            <div class="flex justify-between items-end">
              ...
              <span
                :class="entry.entryType === 'income' ? 'text-green-600 font-semibold' : 'text-red-600 font-semibold'"
              >
